...
CStimulateTablePanel::CStimulateTablePanel(QWidget *parentWidget)
{
    customInit();
    displayResultData();
...
CStimulateTablePanel::~CStimulateTablePanel()
{
...
*
*********************************************************/
void CStimulateTablePanel::customInit()
{
    ...
    vecTemp << tr(u8"序号")<<  tr(u8"幅度 (mV)") << tr(u8"持续时间 (ms)");
    ...
    this->setStyleSheet("#selfDefineStiTableView {"
                         "   alternate-background-color: #535353;" // tableView1 双行颜色
                         "   background-color: #4a4a4a;" // tableView1 单行颜色
                         "}"
                         "#generateWaveNumsTableView {"
                         "   alternate-background-color: #535353;" // tableView2 双行颜色
                         "   background-color: #4a4a4a;" // tableView2 单行颜色
                         "}");
...
*
*********************************************************/
void CStimulateTablePanel::displayResultData()
{
